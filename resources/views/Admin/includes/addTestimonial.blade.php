        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        <br/>
                        <form action="{{ route('addedTestimonial') }}" method="post" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 ">
                                    <input type="file" id="image" name="image" required="required" class="form-control" name="image" value="{{ old('image') }}">
                                </div>
                            </div>
                            @error('image')
                                <div class='alert alert-warning' style="width: 49%; margin-left: 310px">
                            ...
                            <div class="item form-group">
                                <div class="col-md-6 col-sm-6 offset-md-3">
                                    <a href="{{ route('addTestimonial') }}" class="btn btn-primary" type="button">Cancel</a>
