                    ...
                    <div class="x_content">
                        ...
                        <form action="{{ route('updateUser',$user->id) }}" method="post" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 ">
                                    <input type="password" id="password" required="required" class="form-control" name="password" value="{{ $user->password }}">
                                </div>  
                            </div>
                            @error('password')
                                <div class='alert alert-warning' style="width: 49%; margin-left: 310px">
                            ...
                            <div class="item form-group">
                                <div class="col-md-6 col-sm-6 offset-md-3">
                                    <a href="{{ route('user') }}" class="btn btn-primary" type="button">Cancel</a>
