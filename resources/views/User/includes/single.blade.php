...
<div class="site-section">
    ...
    <div class="row">
        ...
        <div class="pt-5">
            @include('User.includes.commentsList')
            @include('User.includes.commentForm')
        </div>
        </div>
        ...
        <div class="sidebar-box">
            ...
            @foreach($categories as $category)
                @php $carsCount = Car::carCount($category->id) @endphp
                <li><a href="#">{{ $category->categoryName }} <span>{{$carsCount}}</span></a></li>
            @endforeach
            </div>
        </div>
        <div class="sidebar-box">
